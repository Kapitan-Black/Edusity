...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "8dffef02-4f83-4863-89fe-8fb4d708f206");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" />Ikletzko@gmail.com</li>
                <li><img src={phone_icon} alt="" />058-7132-111</li>
